  ...
  return (
    <>
      ...
      <main id={'panel'}>
        ...
        <input type={'button'} id={'startBtn5'} onClick={handleLoadWasm} style={{backgroundColor:'yellow',position:'absolute',display:'block',left:'2%',top:'9%',zIndex:6200,border:'4px solid #e7e7e7',borderRadius:'17%'}}></input>
