...
<div id={'wrap'}>
<div id={'contain1'}>
<canvas className='emscripten' id={'scanvas'} style='pointer-events:auto;display:block;position:absolute;z-index:3000;background-color:rgba(233,233,233,1.0);top:0;height:100vh;width:100vh;image-rendering:auto;transform:scaleY(1.0);'></canvas>
